...
func NewOrganizationsHandler(
	...
	return &OrganizationsHandler{
		...
		rolesHandler:         NewRolesHandler(rolesService, logger),
		teamsHandler:         NewTeamsHandler(teamsService, logger),
		invitationsHandler:   NewInvitationsHandler(invitationsService, logger),
		apiKeysHandler:       NewAPIKeysHandler(apiKeysService, logger),
		logger:               logger,
	}
}
...
func (h *OrganizationsHandler) orgContext(c echo.Context) (context.Context, *chi_types.AccessInfo, string, error) {
...
func (h *OrganizationsHandler) GetOrganization(c echo.Context) error {
	ctx, accessInfo, orgID, err := h.orgContext(c)
	if err != nil {
		return err
	}
