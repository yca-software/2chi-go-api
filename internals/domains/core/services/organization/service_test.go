...
func (s *OrganizationServiceSuite) TestCreateOrganization_Success() {
	...
	s.Len(*resp.Roles, len(constants.DefaultRolesToCreateForOrganization))
...
func (s *OrganizationServiceSuite) TestDeleteOrganizationMember_CannotDeleteSelf() {
	...
	memberRole.Permissions = constants.DefaultTeamMemberPermissions
...
func (s *OrganizationServiceSuite) TestDeleteOrganizationMember_Success() {
	...
	deleteRole.Permissions = constants.DefaultTeamMemberPermissions
...
func (s *OrganizationServiceSuite) TestDeleteOrganizationMember_LastPrivilegedMember() {
	...
	ownerRole.Permissions = constants.DefaultOwnerPermissions
