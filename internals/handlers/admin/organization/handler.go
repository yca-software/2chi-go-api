...
func (h *OrganizationsHandler) RegisterRoutes(admin *echo.Group) {
...
func (h *OrganizationsHandler) ListOrganizations(c echo.Context) error {
...
func (h *OrganizationsHandler) ListArchivedOrganizations(c echo.Context) error {
	ctx, accessInfo, err := handler_helpers.UserContext(c)
	if err != nil {
		return err
	}
...
func (h *OrganizationsHandler) GetArchivedOrganization(c echo.Context) error {
	ctx, accessInfo, err := handler_helpers.UserContext(c)
	if err != nil {
		return err
	}
...
func (h *OrganizationsHandler) RestoreOrganization(c echo.Context) error {
	ctx, accessInfo, err := handler_helpers.UserContext(c)
	if err != nil {
		return err
	}
...
func (h *OrganizationsHandler) UpdateOrganizationSubscription(c echo.Context) error {
	ctx, accessInfo, err := handler_helpers.UserContext(c)
	if err != nil {
		return err
	}
...
func (h *OrganizationsHandler) ListOrganizationAuditLogs(c echo.Context) error {
	ctx, accessInfo, err := handler_helpers.UserContext(c)
	if err != nil {
		return err
	}
